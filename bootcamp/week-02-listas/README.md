...
Domina la estructura de datos Lista de Redis: colas, stacks y pipelines de trabajo.
...
- LPOP / RPOP / BLPOP (blocking pop)
- LPOS / LINSERT / LSET
- Casos de uso: job queue, activity feed, stack LIFO
- Límites de rendimiento y cuándo NO usar Lists

---

## 📋 Requisitos Previos

- Haber completado la [Semana 01](../week-01-intro_redis_y_strings/README.md)
...
[← Semana 01](../week-01-intro_redis_y_strings/README.md) | [Semana 03 →](../week-03-sets/README.md)
